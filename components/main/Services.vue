<template>
    <article id="services" class="container py-24">
        <div class="grid grid-cols-3 bg-[url('/assets/images/main/servicesbackground.png')] bg-cover w-full rounded-3xl min-h-[550px]">
            <div class="col-span-3 space-y-5 px-5 py-20 lg:px-11 lg:col-span-2">
                ...
                <h1 class="text-2xl md:text-3xl lg:text-5xl max-w-[650px] font-[25px] mb-2 lg:leading-[3.5rem] text-text leading-[2.5rem]">{{ $t("main.chooseTheService") }}</h1>
                <p class="text-light">{{ $t("main.tellUs") }}</p>
            </div>

            <div class="col-span-3 lg:col-span-1 justify-center items-center lg:flex-col flex gap-2 mt-4">
